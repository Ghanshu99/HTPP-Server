...
printf("Sending 404 page\n");
char tmp[501];
sprintf(tmp,"<DOCTYPE HTML><html lang='en'<head><meta charset='utf-8'><title>TM Web Projector</title></head><body><h2  style='color:red'>Resource / not found</h2></body></html>");	
